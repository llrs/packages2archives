...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, error = FALSE, warning = FALSE, 
                      fig.align = "center", fig.height = 6, fig.width = 15, fig.retina = 3)
library("dplyr")
library("stringr")
library("tidyr")
library("lubridate")
...
Whenever you want
<sup>(On Bioconductor only after each release)</sup>
]

.pull-right[
## Deprecating features/breaking changes

Notify users: NEWS, warnings, [`deprecate`](https://search.r-project.org/R/refmans/base/html/Deprecated.html "Help page of .Deprecated")

And later on [defunct](https://search.r-project.org/R/refmans/base/html/Defunct.html, "Help page of .Defunct"):  
...
.pull-left[
![Meme keep calm and carry on](images/keep-calm-and-carry-on-original.jpg)
]
...
.center[Most packages even if they are archived they return to CRAN]
